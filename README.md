...
(async function(Scratch) {
    ...
    Extension.prototype[`set`] = async (args, util) => {
        if (!(localStorage.getItem(args["2"]) == null)) {
    ...
    Extension.prototype[`ex`] = async (args, util) => {
        return localStorage.getItem(args["d"]) !== null
    };
    ...
    Extension.prototype[`re`] = async (args, util) => {
        if (!(localStorage.getItem(args["12"]) == null)) {
            return localStorage.getItem(args["12"])
        };
    };
    ...
    Extension.prototype[`c`] = async (args, util) => {
        if (!(localStorage.getItem(args["c"]) == null)) {
            variables['1'] = localStorage.getItem(args["c"]) + ' PenguinMod'
            localStorage.setItem(args["c"], (variables['1'] + args["ch"]))
        };
    };
